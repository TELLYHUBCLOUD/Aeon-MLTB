...
async def select(_, message):
    ...
    if len(msg) > 1:
        ...
        msg = (
            "⚠️ Reply to an active /cmd which was used to start the download or add GID along with the command.\n\n"
            "📌 This command is mainly for selecting files from an already added torrent. "
    ...
    try:
        ...
        if task.listener.is_qbit:
            ...
            try:
                ...
                LOGGER.error(f"⚠️ {e} Error in pause, likely due to Aria2 abuse.")
